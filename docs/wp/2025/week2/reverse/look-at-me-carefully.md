...
![main 函数分析](/assets/images/wp/2025/week2/look-at-me-carefully_1.png)

函数内部插入了大量的无意义的混淆代码，静态很难分析。

![混淆代码](/assets/images/wp/2025/week2/look-at-me-carefully_2.png)
...
![动态调试](/assets/images/wp/2025/week2/look-at-me-carefully_3.png)

我们执行了几个函数，观察内存窗口，发现该内存多了如下输入 `1fgj2s63`，根据和输入的观察发现是从输入中按照一定的顺序取出字符放到新的一片内存中，而顺序就是函数的第三个参数，而数组下标超出输入的长度的函数是不会进行取输入操作的。

![内存变化](/assets/images/wp/2025/week2/look-at-me-carefully_4.png)
