...
![main 函数内容](/assets/images/wp/2025/week1/input-function_1.png)

由于一般程序是从 `main` 函数开始提供服务的，所以我们重点分析 `main` 函数

在左侧 `function name` 表中双击 `main` 这个函数名：

![逻辑分析](/assets/images/wp/2025/week1/input-function_2.jpg)
...
![报错信息](/assets/images/wp/2025/week1/input-function_3.png)
