...
![image-20251105011158940](/assets/images/wp/2025/week1/compression-magic_1.png)

点击开始，我们就得到了第一关压缩包加密的密码：`ns2025`。

![image-20251105011303164](/assets/images/wp/2025/week1/compression-magic_2.png)
...
![image-20251106195219287](/assets/images/wp/2025/week1/compression-magic_3.png)

将 `09 00` 改为 `00 00`。

![image-20251106195250231](/assets/images/wp/2025/week1/compression-magic_4.png)
...
![image-20251106205414193](/assets/images/wp/2025/week1/compression-magic_5.png)
...
![image-20251106212840738](/assets/images/wp/2025/week1/compression-magic_6.png)

然后我们可以用 key 删除密码，在同一目录下生成一个具有相同内容但不加密的 `flag2.zip`

![image-20251106213042105](/assets/images/wp/2025/week1/compression-magic_7.png)
